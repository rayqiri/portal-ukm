...
$no=0;
$result=mysql_query("select * from bendahara,kegiatan where kegiatan.id=bendahara.id and bendahara.id='$keg' order by bendahara.date asc");
...
<tr> 
        ...
        <td class="cetak" align="right">Rp. <?php echo $masuk;?></td>
        <td class="cetak" align="right">Rp. <?php echo $keluar;?></td>
...
$sql=mysql_query("select * from bendahara where id='$keg'");
...
?>
<tr>
					<th colspan=15 align="left">Total Pemasukan: Rp. <?php echo $totm; ?></th>
</tr>
<tr>
					<th colspan=15 align="left">Total Pengeluaran: Rp. <?php echo $totk; ?></th>
</tr>
<tr>
					<th colspan=15 align="left">Total Saldo: Rp. <?php echo $tots; ?></th>
</tr> 
</table>
